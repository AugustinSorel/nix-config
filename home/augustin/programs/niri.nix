...

{
  wayland.windowManager.niri = {
    ...
    spawn-sh-at-startup._args = [ "dms run" ];
    ...
    screenshot-path = "~/Pictures/Screenshots/Screenshot from %Y-%m-%d %H-%M-%S.png";
      ...
      binds = {
        ...
        "Mod+D" = {
          _props.hotkey-overlay-title = "Spotlight";
      ...
      # Top-level nodes that require _args (named outputs, startup commands, window rules)
      _children = [
        {
